...
from .views import PostView, PostDetailView, CommentView, DetailCommentView
from . import view
...
#     path('get/<int:_id>', DetailPostView.as_view(), name='get_one_post'),
    path('get/<int:pk>', PostDetailView.as_view(), name='crud'),
...
#     path('comment/create', CommentView.as_view(), name = 'com_create'),
    path('comment/<int:pk>', DetailCommentView.as_view(), name='get_one_com'),
...
#     path('new_post', PostView.as_view(), name='post_form'),
